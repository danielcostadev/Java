...
/**
 * 
 * Cadastro e Listagem de Aulas em uma lista
 * @author Daniel Costa
 * 
 * 
 */
public class TesteListaAulas {
	...
	public static void main(String[] args) throws NumberFormatException, NullPointerException, NoSuchElementException {
		...
		try (Scanner teclado = new Scanner(System.in)) {
			...
			do {
				...
				// toLowerCase força o caractere minusculo mesmo o usuário digitando maiúsculo
